...
class RelativeBinningTimeDomainGeocentTimeFrame(bilby.Likelihood):
    """
    Time-domain likelihood class implementing heterodyining in time domain for fast parameter estimation. This likelihood assumes stationary gaussian noise which gives symmetric Toeplitz covariance matrix and uses Gohberg-Semencul representation for efficient matrix conversion. Currently, this implementation is limited to (2,2) mode. 
    ...
    y : 
    Noise : array-like
        Noise properties (time series of noise realisation) of the detectors.
