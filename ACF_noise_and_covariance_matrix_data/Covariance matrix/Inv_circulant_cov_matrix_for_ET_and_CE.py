...
------------------------------------
This script generates gaussian noise and computes the first row of inverse of (circulant) covariance matrix for specified gravitational wave detectors (ET and CE).
...
ET_ifos = bilby.gw.detector.get_empty_interferometer("ET")
CE_ifo = bilby.gw.detector.get_empty_interferometer("CE")
Detectors_list = [ET_ifos[0],ET_ifos[1],ET_ifos[2],CE_ifo]
...
with open("C_inv_row_" + str(length_of_noise_segment) + "_sec_ET_CE.pkl", "wb") as f:
